<template>
  <div>
    ...
    <div class="container">
      <div v-if="codici == null">
        <div class="container my-5">
          <div class="text-center py-5">
            <figure class="figure ">
              <img
                src="Assets/icone/empty.svg"
                style="width: 100px;"
                class="rounded img-fluid "
                alt="empty"
              />
              <figcaption class="figure-caption">
                Non ci sono codici salvati,<br />
      ...
      <div v-else>
        <codiceLista
          v-for="(codice, index) in codici"
          :key="index"
          imglogo="assets/icone/tag_black_24dp.svg"
          :titolo="codice.titolo"
          :imgtipo="codice.imgtipo"
          :imgpreferiti="codice.imgpreferiti"
          :descrizione="codice.descrizione"
          :isBookmarked="codice.isBookmarked"
          :tipo="codice.tipo"
          :contenuto="codice.contenuto"
        ></codiceLista>
      </div>
    </div>
    <div class="position-fixed bottom-0 end-0">
      <div class="btn-group" role="group" aria-label="Basic example">
        <button type="button" class="btn btn-success mx-3 my-3">
          <router-link
            :to="{
              name: 'scansione',
              params: {
            ...
            >Aggiungi Codice QR</router-link
          >
        </button>
        <button type="button" class="btn btn-success mx-3 my-3">
          <router-link
            ...
            >Aggiungi Barcode EAN13</router-link
          >
        </button>
      </div>
    </div>
